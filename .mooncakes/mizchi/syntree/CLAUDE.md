...
- `src/` - Core syntax tree + highlighter runtime packages
- `src/syntree_api` - JS export wrapper package
- `js/syntree_api.js` - Convenience JS facade over MoonBit build output
...
moon ide outline src/types.mbt
```
